...
/* Explanation:
  ...
  Container View: Acts as the main wrapper without introducing an additional scroll layer.
  FlatList: Manages its own scrolling, rendering only visible items and optimizing performance.
  IconButton Container: Aligns icon buttons horizontally using flexDirection: 'row' and
  justifyContent: 'space-between'.

Expected Behavior:

  Smooth Scrolling: The list scrolls seamlessly without any nested scroll conflicts.
  Responsive Layout: Components adjust appropriately based on screen size and orientation.
  Enhanced Performance: FlatList optimizes rendering, especially with larger datasets. */
